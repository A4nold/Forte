...
<html>
  ...
  if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if(isset($_POST['enter'])){
        require 'php/usertransactionhistory.php';
    }
            ...
            <div class="content-box">
              <div class="element-wrapper compact pt-4">
                ...
                <div class="element-box-tp">
                  ...
                  <a class="btn btn-primary btn-sm" href="auth_admin_register.php"><i class="os-icon os-icon-ui-22"></i><span>Register New User</span></a>
              ...
              <div class='form-group row'>
                ...
                <div class='col-sm-8'>
                  <input class='form-control' placeholder='Enter Amount' type='number' name='amt'>
                </div>
              </div>
              ...
              <fieldset class='form-group row'>
                ...
                <div class='col-sm-8'>
                  <input class='form-control' placeholder='Transaction Type' type='text' name='type'>
                </div>
              </fieldset>
              ...
              <div class='form-buttons-w'>
                <button class='btn btn-primary' type='transfer' name="enter"> Submit</button>
              </div>
              <div id="result"></div>
