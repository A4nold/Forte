            ...
            <div class="content-box">
              <div class="element-wrapper compact pt-4">
                <div class="element-actions">
                  <a class="btn btn-primary btn-sm" href="apps_bank_transfer.php"><i class="os-icon os-icon-ui-22"></i><span>Deposit</span></a><a class="btn btn-primary btn-sm" href="apps_bank_internationaltransfer.php"><i class="os-icon os-icon-grid-10"></i><span>International Transfer</span></a><a class="btn btn-success btn-sm" href="apps_bank_localtransfer.php"><i class="os-icon os-icon-grid-10"></i><span>Local Transfer</span></a>
                </div>
